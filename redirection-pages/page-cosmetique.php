<?php 
	...
	$reqcosmetique=$db->query("SELECT * FROM produit WHERE type_id=1 ORDER BY prix DESC");
			...
			<h2>
				<span class="badge badge-striped badge-pill badge-info" style="padding: 15px;">
					...
					<span style="color: red;">
						<?php 
								$compteur=$db->query("SELECT count(type_id) AS nombreCosmetique FROM produit WHERE type_id=1");
								
								$affiche=$compteur->fetchAll();
								foreach ($affiche as $affiches) {
									echo $affiches['nombreCosmetique'];
						...
						Produit(s)  Cosmétique(s) <span class="text-danger">.</span>
				</span>
			</h2>
			...
			<div class="col-lg-8" style="">
				...
				?>
						...
						<div class="row blokc1" style="padding: 15px 0 5px 30px;background: #e6e9f0;">
							...
							<div class="col-lg-8">
								<div class="ici" style="margin-left: 15px;padding: 15px;">
